...
<div class="container w-50 mt-5 p-5 shadow">
	<form action="${ctx}/memberInsert.do" method="post">
		...
		<div class="row mb-2">
			<div class="col-md-6">
				<input class="form-control mb-2" type="text" id="sample2_postcode" name="zipcode" placeholder="우편번호" readonly>
			</div>
			<div class="col-md-6 p-0 ps-2">
				<a class="btn btn-sm btn-outline-secondary p-2" onclick="sample2_execDaumPostcode()">우편번호 찾기</a><br>
			</div>
		</div>
