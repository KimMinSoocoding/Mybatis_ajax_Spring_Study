...
<div class="container mt-5">
	...
	<table class="table table-border text-center">
		...
		<c:forEach var="dto" items="${list}">
			<tr>
				...
				<td>${dto.sMajor}</td>
				<td>
					<a href="delete.do?sid=${dto.sid}" class="btn btn-outline-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
	...
	<div class="text-center">
		...
		<a href="list.do" class="btn btn-primary">전체학생 리스트</a>
	</div>
