...
public class ProductDTO {
	...
	public ProductDTO(int pNum, String pName, String pCategory_fk,  String pImage, int pQty,
	...
	public String toString() {
		return "ProductDTO [pNum=" + pNum + ", pName=" + pName + ", pCategory_fk=" + pCategory_fk + ", pImage=" + pImage + ", pQty=" + pQty + ", price=" + price + ", pSpec=" + pSpec
