...
<script type="text/javascript" src="js/validChk.js"></script>
</head>
<body>
<div class="container mt-5 w-50 p-4">
	...
	<table class="table table-border">
		...
		<tbody>
			...
			<tr>
				<td>성별</td>
				<td>
				<input type="radio" id="m" value="남" name="sGender" checked><label for="m">남</label>
	...
	<div class="text-center">
		<input type = "button" value="등록하기" class="btn btn-primary" onclick="inputChk()"/>
