...
<main>
   <div class="container mt-5 d-flex">
      ...
      <div class="d-flex">
         ...
         %>
         <div class="card me-4" style="width:200px; position:relative;">
            <a href="prod_view.jsp?pNum=<%=pNum%>&pSpec=<%=pSpec%>" style="overflow:hidden; height:120px;">
                ...
                style="width:100%;">
               <span class="p-1" style="font-size:12px; position:absolute; top:10px; left:10px; color:white; background:red;"><%=specName%></span>
             </a>   
             <div class="card-body">
